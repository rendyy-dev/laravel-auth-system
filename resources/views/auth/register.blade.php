    ...
    <div x-data="{ show: {{ $errors->any() ? 'true' : 'false' }}, password: '', confirmPassword: '' }"
        ...
        <div class="space-y-4">
            ...
            <form method="POST" action="{{ route('register') }}" class="space-y-3">
                ...
                <x-text-input name="name" type="text" class="w-full" placeholder="Name" required />
                <x-text-input name="username" type="text" class="w-full" placeholder="Username" required />
                <x-text-input name="email" type="email" class="w-full" placeholder="Email" required />
